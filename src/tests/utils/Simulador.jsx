...
// LISTA DE INFORMACOES
      {
        ...
        caminho: 'https://swapi-trybe.herokuapp.com/api/planets/8/',
      },
      {
        name: 'Alderaan',
        rotation_period: '24',
        ...
        caminho: 'https://swapi-trybe.herokuapp.com/api/planets/2/',
      },
...

      {
        ...
        caminho: 'https://swapi-trybe.herokuapp.com/api/planets/5/',
      },
      {
        name: 'Bespin',
        rotation_period: '12',
        ...
        caminho: 'https://swapi-trybe.herokuapp.com/api/planets/6/',
      },
      {
        name: 'Tatooine',
        rotation_period: '23',
        ...
        caminho: 'https://swapi-trybe.herokuapp.com/api/planets/1/',
      },
      {
        name: 'Yavin IV',
        rotation_period: '24',
        ...
        caminho: 'https://swapi-trybe.herokuapp.com/api/planets/3/',
      },
      {
        name: 'Hoth',
        rotation_period: '23',
        ...
        caminho: 'https://swapi-trybe.herokuapp.com/api/planets/4/',
      },
      {
        name: 'Endor',
        rotation_period: '18',
        ...
        caminho: 'https://swapi-trybe.herokuapp.com/api/planets/7/',
      },
     
      {
        ...
        caminho: 'https://swapi-trybe.herokuapp.com/api/planets/10/',
      },
      {
        name: 'Coruscant',
        rotation_period: '24',
        ...
        caminho: 'https://swapi-trybe.herokuapp.com/api/planets/9/',
      },
// LISTA DE INFORMACOES
